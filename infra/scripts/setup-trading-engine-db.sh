...
# Trading Engine Database Setup Script for Cloud SQL
# Creates database and user for the trading engine service
...
echo "🚀 Setting up Trading Engine database in Cloud SQL..."
...
-- Connect to the trading engine database
\c $DATABASE_NAME;
...
echo ""
echo "🎉 Trading Engine database setup completed!"
echo ""
...
echo ""
echo "🚀 Next steps:"
echo "  1. Update trading engine application properties with database credentials"
echo "  2. Run the trading engine build (it will auto-initialize tables)"
echo "  3. Verify table creation after first startup"
echo ""
echo "💡 Note: The trading engine will automatically create tables on first startup"
echo "   using the init_database.sql script included in the Docker image."
echo ""
