...
# Wallet Service Database Setup Script for Cloud SQL
# Creates database and user for the wallet service
...
DB_USER="wallet_service"
DB_PASSWORD="alphintra@123"

echo "🚀 Setting up Wallet Service database in Cloud SQL..."
...
-- Connect to the wallet service database
\c $DATABASE_NAME;
...
echo ""
echo "🎉 Wallet Service database setup completed!"
echo ""
...
echo ""
echo "🚀 Next steps:"
echo "  1. Update wallet service application configuration with database credentials"
echo "  2. Run the wallet service build (it will auto-initialize tables)"
echo "  3. Verify table creation after first startup"
echo ""
echo "💡 Note: The wallet service will automatically create tables on first startup"
echo "   using the init_database.py script included in the Docker image."
echo "   Tables to be created: users, wallet_connections"
echo ""
