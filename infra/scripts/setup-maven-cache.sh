...
# GCS Maven Cache Bucket Setup Script
# Creates and configures the Maven dependency cache bucket for Cloud Build optimization

set -e

# Configuration
PROJECT_ID="alphintra-472817"
BUCKET_NAME="${PROJECT_ID}-mvn-cache"
REGION="us-central1"
CACHE_RETENTION_DAYS=30

echo "🚀 Setting up Maven cache bucket for Cloud Build optimization..."
...
gsutil -m touch "gs://$BUCKET_NAME/.m2/repository/.gitkeep" 2>/dev/null || true

# Display bucket information
echo ""
echo "🎉 Maven cache bucket setup completed!"
echo ""
echo "Bucket Details:"
...
echo ""
echo "🚀 Next steps:"
echo "  1. Update your cloudbuild.yaml to use this cache bucket"
echo "  2. Run a test build to populate the cache"
echo "  3. Monitor cache hit rates in subsequent builds"
echo ""
echo "💡 Tip: First build will populate cache, subsequent builds will be much faster!"