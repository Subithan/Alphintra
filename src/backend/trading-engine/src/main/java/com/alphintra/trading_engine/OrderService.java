...
public class OrderService {
    ...
    public OrderResponse createOrder(OrderRequest request) {
        ...
        order.setOrderId(null); // ID will be generated by BIGSERIAL
        ...
        order.setAveragePrice(null);
        order.setFee(null);
        order.setExchange("internal");
        ...
        redisTemplate.opsForValue().set(ORDER_CACHE_PREFIX + order.getOrderUuid().toString(), order);
    ...
    public OrderResponse getOrder(UUID orderUuid) {
        // Check Redis cache
        Order cachedOrder = (Order) redisTemplate.opsForValue().get(ORDER_CACHE_PREFIX + orderUuid.toString());
        if (cachedOrder != null) {
        ...
        // Cache in Redis
        redisTemplate.opsForValue().set(ORDER_CACHE_PREFIX + orderUuid.toString(), order);
        return mapToResponse(order);
    }
