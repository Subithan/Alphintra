...
CREATE TABLE IF NOT EXISTS orders (
    ...
    user_id BIGINT NOT NULL REFERENCES users(user_id) ON DELETE CASCADE,
    account_id BIGINT NOT NULL REFERENCES trading_accounts(account_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS trading_strategies (
    ...
    strategy_uuid UUID NOT NULL UNIQUE,
    user_id BIGINT NOT NULL REFERENCES users(user_id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS trading_signals (
    ...
    strategy_id BIGINT NOT NULL REFERENCES trading_strategies(strategy_id) ON DELETE CASCADE,
    symbol VARCHAR(20) NOT NULL,
...
INSERT INTO asset_balances (account_id, asset, total_balance, available_balance)
SELECT account_id, 'USD', 100000.0, 100000.0
FROM trading_accounts WHERE account_type = 'SPOT' AND exchange = 'internal'
ON CONFLICT (account_id, asset) DO NOTHING;

INSERT INTO asset_balances (account_id, asset, total_balance, available_balance)
SELECT account_id, 'BTC', 0.0, 0.0
FROM trading_accounts WHERE account_type = 'SPOT' AND exchange = 'internal'
ON CONFLICT (account_id, asset) DO NOTHING;
