...
// Import the new components (assuming they are correctly defined with their own styling)
...
const AuthPage: React.FC = () => {
  ...
  return (
    // Main container now uses CSS Grid to define column ratios
    <div className="min-h-screen bg-black grid grid-cols-[1fr_min-content_1fr] font-['Inter']"> {/* Added min-content for the line column */}
      {/* Left Side - Branding */}
  ...
  width={192} // 48 * 4 ( Tailwind's w-48 is 12rem = 192px), adjust to your image's intrinsic width
  height={192} // 48 * 4 (Tailwind's h-48 is 12rem = 192px), adjust to your image's intrinsic height
...
/>
      ...
      <div className="w-[2px] h-full bg-gradient-to-b from-black via-yellow-500 to-black"></div> {/* This is the new line */}
