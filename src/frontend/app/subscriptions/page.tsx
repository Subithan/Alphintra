...
import { SubscriptionCard, SubscriptionComparison, SubscriptionHeader, SubscriptionFAQ } from '@/components/subscriptions';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/20">
      <div className="container mx-auto px-4 py-12 md:py-20">
        ...
        {showComparison && (
          <Card className="max-w-6xl mx-auto mb-16 overflow-hidden">
